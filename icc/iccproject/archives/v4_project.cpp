...
// ------------------------test----------------------------------------
//list_cell find_empty_cell(table maze);
//bool maze_full(table maze);
...
{	
	...
	{
		list_cell neighbours = find_neighbours(maze, last_crown[i]);
